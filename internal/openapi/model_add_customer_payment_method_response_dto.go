...
// AddCustomerPaymentMethodResponseDto struct for AddCustomerPaymentMethodResponseDto
type AddCustomerPaymentMethodResponseDto struct {
	// The Stripe checkout url to which to redirect customers to complete payment method creation
	Url string `json:"url"`
}
...
func NewAddCustomerPaymentMethodResponseDto(url string) *AddCustomerPaymentMethodResponseDto {
	this := AddCustomerPaymentMethodResponseDto{}
	this.Url = url
	return &this
}
...
func (o AddCustomerPaymentMethodResponseDto) MarshalJSON() ([]byte, error) {
...
type NullableAddCustomerPaymentMethodResponseDto struct {
	value *AddCustomerPaymentMethodResponseDto
	isSet bool
}

func (v NullableAddCustomerPaymentMethodResponseDto) Get() *AddCustomerPaymentMethodResponseDto {
	return v.value
}

func (v *NullableAddCustomerPaymentMethodResponseDto) Set(val *AddCustomerPaymentMethodResponseDto) {
	v.value = val
	v.isSet = true
}

func (v NullableAddCustomerPaymentMethodResponseDto) IsSet() bool {
	return v.isSet
}

func (v *NullableAddCustomerPaymentMethodResponseDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableAddCustomerPaymentMethodResponseDto(val *AddCustomerPaymentMethodResponseDto) *NullableAddCustomerPaymentMethodResponseDto {
	return &NullableAddCustomerPaymentMethodResponseDto{value: val, isSet: true}
}

func (v NullableAddCustomerPaymentMethodResponseDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableAddCustomerPaymentMethodResponseDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
