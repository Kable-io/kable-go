...
// ResourceEntitlementResponseDto struct for ResourceEntitlementResponseDto
type ResourceEntitlementResponseDto struct {
...
func NewResourceEntitlementResponseDto(name string, entitlementId string, externalId string, datatype string, description string, created time.Time, modified time.Time, value map[string]interface{}) *ResourceEntitlementResponseDto {
	this := ResourceEntitlementResponseDto{}
	this.Name = name
...
func (o ResourceEntitlementResponseDto) MarshalJSON() ([]byte, error) {
...
type NullableResourceEntitlementResponseDto struct {
	value *ResourceEntitlementResponseDto
	isSet bool
}

func (v NullableResourceEntitlementResponseDto) Get() *ResourceEntitlementResponseDto {
	return v.value
}

func (v *NullableResourceEntitlementResponseDto) Set(val *ResourceEntitlementResponseDto) {
	v.value = val
	v.isSet = true
}

func (v NullableResourceEntitlementResponseDto) IsSet() bool {
	return v.isSet
}

func (v *NullableResourceEntitlementResponseDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableResourceEntitlementResponseDto(val *ResourceEntitlementResponseDto) *NullableResourceEntitlementResponseDto {
	return &NullableResourceEntitlementResponseDto{value: val, isSet: true}
}

func (v NullableResourceEntitlementResponseDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableResourceEntitlementResponseDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
