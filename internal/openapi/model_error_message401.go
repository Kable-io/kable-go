...
// ErrorMessage401 struct for ErrorMessage401
type ErrorMessage401 struct {
...
func (o ErrorMessage401) MarshalJSON() ([]byte, error) {
...
type NullableErrorMessage401 struct {
	value *ErrorMessage401
	isSet bool
}

func (v NullableErrorMessage401) Get() *ErrorMessage401 {
	return v.value
}

func (v *NullableErrorMessage401) Set(val *ErrorMessage401) {
	v.value = val
	v.isSet = true
}

func (v NullableErrorMessage401) IsSet() bool {
	return v.isSet
}

func (v *NullableErrorMessage401) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableErrorMessage401(val *ErrorMessage401) *NullableErrorMessage401 {
	return &NullableErrorMessage401{value: val, isSet: true}
}

func (v NullableErrorMessage401) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableErrorMessage401) UnmarshalJSON(src []byte) error {
	v.isSet = true
