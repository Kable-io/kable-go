...
// PlanPriceRequestDto struct for PlanPriceRequestDto
type PlanPriceRequestDto struct {
...
func (o PlanPriceRequestDto) MarshalJSON() ([]byte, error) {
...
type NullablePlanPriceRequestDto struct {
	value *PlanPriceRequestDto
	isSet bool
}

func (v NullablePlanPriceRequestDto) Get() *PlanPriceRequestDto {
	return v.value
}

func (v *NullablePlanPriceRequestDto) Set(val *PlanPriceRequestDto) {
	v.value = val
	v.isSet = true
}

func (v NullablePlanPriceRequestDto) IsSet() bool {
	return v.isSet
}

func (v *NullablePlanPriceRequestDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullablePlanPriceRequestDto(val *PlanPriceRequestDto) *NullablePlanPriceRequestDto {
	return &NullablePlanPriceRequestDto{value: val, isSet: true}
}

func (v NullablePlanPriceRequestDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullablePlanPriceRequestDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
