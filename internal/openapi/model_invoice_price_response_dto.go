...
// InvoicePriceResponseDto struct for InvoicePriceResponseDto
type InvoicePriceResponseDto struct {
...
func (o InvoicePriceResponseDto) MarshalJSON() ([]byte, error) {
...
type NullableInvoicePriceResponseDto struct {
	value *InvoicePriceResponseDto
	isSet bool
}

func (v NullableInvoicePriceResponseDto) Get() *InvoicePriceResponseDto {
	return v.value
}

func (v *NullableInvoicePriceResponseDto) Set(val *InvoicePriceResponseDto) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoicePriceResponseDto) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoicePriceResponseDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoicePriceResponseDto(val *InvoicePriceResponseDto) *NullableInvoicePriceResponseDto {
	return &NullableInvoicePriceResponseDto{value: val, isSet: true}
}

func (v NullableInvoicePriceResponseDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoicePriceResponseDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
