...
// BundleResponseDto struct for BundleResponseDto
...
func (o BundleResponseDto) MarshalJSON() ([]byte, error) {
...
type NullableBundleResponseDto struct {
	value *BundleResponseDto
	isSet bool
}

func (v NullableBundleResponseDto) Get() *BundleResponseDto {
	return v.value
}

func (v *NullableBundleResponseDto) Set(val *BundleResponseDto) {
	v.value = val
	v.isSet = true
}

func (v NullableBundleResponseDto) IsSet() bool {
	return v.isSet
}

func (v *NullableBundleResponseDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBundleResponseDto(val *BundleResponseDto) *NullableBundleResponseDto {
	return &NullableBundleResponseDto{value: val, isSet: true}
}

func (v NullableBundleResponseDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBundleResponseDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
