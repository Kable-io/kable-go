...
// InvoiceLineItemTierResponseDtoUsage The usage consumption for the line item.
type InvoiceLineItemTierResponseDtoUsage struct {
...
func NewInvoiceLineItemTierResponseDtoUsage(aggregation string, dimensionId string, total float32) *InvoiceLineItemTierResponseDtoUsage {
	this := InvoiceLineItemTierResponseDtoUsage{}
...
func (o InvoiceLineItemTierResponseDtoUsage) MarshalJSON() ([]byte, error) {
...
type NullableInvoiceLineItemTierResponseDtoUsage struct {
	value *InvoiceLineItemTierResponseDtoUsage
	isSet bool
}

func (v NullableInvoiceLineItemTierResponseDtoUsage) Get() *InvoiceLineItemTierResponseDtoUsage {
	return v.value
}

func (v *NullableInvoiceLineItemTierResponseDtoUsage) Set(val *InvoiceLineItemTierResponseDtoUsage) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceLineItemTierResponseDtoUsage) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceLineItemTierResponseDtoUsage) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceLineItemTierResponseDtoUsage(val *InvoiceLineItemTierResponseDtoUsage) *NullableInvoiceLineItemTierResponseDtoUsage {
	return &NullableInvoiceLineItemTierResponseDtoUsage{value: val, isSet: true}
}

func (v NullableInvoiceLineItemTierResponseDtoUsage) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceLineItemTierResponseDtoUsage) UnmarshalJSON(src []byte) error {
	v.isSet = true
