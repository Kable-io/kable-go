...
// InvoiceCustomerResponseDto struct for InvoiceCustomerResponseDto
type InvoiceCustomerResponseDto struct {
...
func NewInvoiceCustomerResponseDto(customerId string, clientId string, companyName string) *InvoiceCustomerResponseDto {
	this := InvoiceCustomerResponseDto{}
...
func (o InvoiceCustomerResponseDto) MarshalJSON() ([]byte, error) {
...
type NullableInvoiceCustomerResponseDto struct {
	value *InvoiceCustomerResponseDto
	isSet bool
}

func (v NullableInvoiceCustomerResponseDto) Get() *InvoiceCustomerResponseDto {
	return v.value
}

func (v *NullableInvoiceCustomerResponseDto) Set(val *InvoiceCustomerResponseDto) {
	v.value = val
	v.isSet = true
}

func (v NullableInvoiceCustomerResponseDto) IsSet() bool {
	return v.isSet
}

func (v *NullableInvoiceCustomerResponseDto) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableInvoiceCustomerResponseDto(val *InvoiceCustomerResponseDto) *NullableInvoiceCustomerResponseDto {
	return &NullableInvoiceCustomerResponseDto{value: val, isSet: true}
}

func (v NullableInvoiceCustomerResponseDto) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableInvoiceCustomerResponseDto) UnmarshalJSON(src []byte) error {
	v.isSet = true
